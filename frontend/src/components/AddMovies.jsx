...
function AddMovies() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setMovie({ id: '', title: '', rating: '', poster: '', release_year: '', film_duration: '' });
            ...
            <div className="card mt-4 p-4">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                        ...
                        <input type="number" className="form-control" name="id" value={movie.id} onChange={handleChange} required />
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="number" step="0.1" className="form-control" name="rating" value={movie.rating} onChange={handleChange} required />
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="number" className="form-control" name="release_year" value={movie.release_year} onChange={handleChange} required />
                    </div>
                    <div className="mb-3">
                        <label className="form-label">Duration (minutes)</label>
                        <input type="text" className="form-control" name="film_duration" value={movie.film_duration} onChange={handleChange} required />
                    </div>
